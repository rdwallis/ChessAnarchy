...
package com.wallissoftware.chessanarchy.client.place;
...
public class PlaceManager extends PlaceManagerImpl {
	...
	@Inject
	public PlaceManager(final EventBus eventBus, final TokenFormatter tokenFormatter, @DefaultPlace final String defaultPlaceNameToken) {
