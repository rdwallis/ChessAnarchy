...
package com.wallissoftware.useragent.client;
...
public class UserAgentAsserter implements EntryPoint {
    ...
    public void onModuleLoad() {
        final UserAgent impl = GWT.create(UserAgent.class);

        final String compileTimeValue = impl.getCompileTimeValue();
        final String runtimeValue = impl.getRuntimeValue();
