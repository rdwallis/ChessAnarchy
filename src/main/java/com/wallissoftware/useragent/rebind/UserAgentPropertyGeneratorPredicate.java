...
public class UserAgentPropertyGeneratorPredicate {
    ...
    public UserAgentPropertyGeneratorPredicate(final String userAgent) {
    ...
    public UserAgentPropertyGeneratorPredicate println(final String s) {
        predicateWriter.println(s);
        return this;
    }

    public UserAgentPropertyGeneratorPredicate returns(final String s) {
        returnValue = s;
        return this;
    }
