...
public class ABoardShould {
    ...
    public void playTheseGameWithoutIssue() {
        ...
        failToPlayGame("d4", "Nf6", "c4", "Nc6", "d5", "Ne5", "Nc3", "e6", "dxe6", "Qe7", "e4", "Qxe6", "Bg5", "Nc6", "Bd3", "Bb4", "Bxf6", "Qxf6", "Ne2", "Bxc3+", "O-O", "O-O", "Nxc3", "d5", "f4", "d4", "h3", "dxc3", "bxc3");
    ...
    public void playGameOnMoveNode(final String... moves) throws IllegalMoveException {
    ...
    public void failToPlayGame(final String... moves) {
        try {
            playGameOnMoveNode(moves);
            fail();
        } catch (final IllegalMoveException e) {
